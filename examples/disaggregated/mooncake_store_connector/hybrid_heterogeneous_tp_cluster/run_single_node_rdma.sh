...
store_tp_size=${STORE_TP_SIZE:-4}
prefix_match_unit=${PREFIX_MATCH_UNIT:-16}
prompt_tokens=${PROMPT_TOKENS:-1601}
prompt_repetitions=${PROMPT_REPETITIONS:-256}
output_tokens=${OUTPUT_TOKENS:-816}
reference_output_tokens=${REFERENCE_OUTPUT_TOKENS:-64}
expected_decode_cached_tokens=${EXPECTED_DECODE_CACHED_TOKENS:-1600}
expected_extended_cached_tokens=${EXPECTED_EXTENDED_CACHED_TOKENS:-2400}
